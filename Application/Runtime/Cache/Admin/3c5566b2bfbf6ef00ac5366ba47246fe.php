...
<head>
    ...
    <link rel="stylesheet" href="/php/zhangqie/Public/font-awesome/css/font-awesome.css" >
    <link rel="stylesheet" href="/php/zhangqie/Public/css/animate.css" >
    <link rel="stylesheet" href="/php/zhangqie/Public/css/admin-style.css?v=2.2.0" >
    ...
    <div>
        ...
        <form id="form" name="form" method="post" action="<?php echo U('checkLogin');?>"  autocomplete="off">
            ...
            <div class="form-group login">
                ...
                <a> <img class="reloadverify" src="<?php echo U('Admin/Public/code');?>"  id="imgcode" onClick="this.src=this.src+'?'+Math.random()"></a>
            </div>
