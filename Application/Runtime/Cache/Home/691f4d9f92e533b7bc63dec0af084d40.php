...
<div class="ibody">
  <header>
    ...
    <nav id="topnav"><a id="backindex" href="<?php echo U(Index/index);?>">首页</a><a href="/php/zhangqie/index.php/Home/Resume/resume">个人简历</a><a href="<?php echo U(Quotations/quotations);?>">生活语录</a><a href="<?php echo U('About/about');?>">关于我的</a><a href="<?php echo U('Message/message');?>">给我留言</a></nav>
  </header>
  ...
  <article>
    ...
    <div class="bloglist">
      ...
      <div class="blogs">
        ...
        <figure><img src="/php/zhangqie/Public/images/01.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/php/zhangqie/Public/images/02.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/php/zhangqie/Public/images/03.png" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/php/zhangqie/Public/images/04.jpg" ></figure>
        <ul>
      ...
      <div class="blogs">
        ...
        <figure><img src="/php/zhangqie/Public/images/04.png" ></figure>
        <ul>
  ...
  <aside>
    <div class="avatar"><a href="about.html"><span>切切歆语</span></a></div>
