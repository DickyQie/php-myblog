...
<style type="text/css">
	#backquotationsn { background: #e41635 }/* 高亮选中颜色 */
</style>
<div class="ibody">
   <header>
     <h1>切切歆语</h1>
  ...
  <article>
    ...
    <div class="bloglist">
      <div class="newblog">
        ...
        <figure><img src="/php/zhangqie/Public/images/001.jpg" ></figure>
      ...
      <div class="newblog">
        ...
        <figure><img src="/php/zhangqie/Public/images/005.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="/php/zhangqie/Public/images/008.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="/php/zhangqie/Public/images/002.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
        ...
        <figure><img src="/php/zhangqie/Public/images/003.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
      <div class="newblog">
        <ul>
      ...
      <div class="newblog">
        ...
        <figure><img src="/php/zhangqie/Public/images/004.jpg" ></figure>
        <div class="dateview">2014-04-08</div>
      </div>
    </div>
